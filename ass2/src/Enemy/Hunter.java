...
public class Hunter extends Enemy {
    ...
    {
        Path path = new Path();
        ArrayList<Location> road = path.path(this.map, this.map.getPosition(Objects.hunter), this.map.getPosition(Objects.player));
        ...
        for (int i  = road.size() - 1; i >= 0; i -- )
        {
            ...
            this.map.setupMap(new Coordinate(x, y, Objects.hunter));
